...
print(pacienti)
print("Adaugare linie prin concat:")
linie_adaugata = pd.DataFrame([["Popa Leon",80,80]],columns=["Nume","Varsta","Greutate"])
pacienti = pd.concat([pacienti,linie_adaugata],axis=0)
print(pacienti)

print("Inserare coloana prin insert:")
pacienti.insert(4,"Tensiune_s",[12,10,12,14,15,9])
print(pacienti)
