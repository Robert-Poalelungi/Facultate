...
"color: rgb(0, 85, 0);")
        ...
        self.combo_rotatie = QComboBox(self.groupBox_2)
        self.combo_rotatie.setObjectName(u"combo_rotatie")
        self.combo_rotatie.setStyleSheet(u"font: 12pt \"MS Shell Dlg 2\";")

        self.gridLayout.addWidget(self.combo_rotatie, 1, 2, 1, 1)
