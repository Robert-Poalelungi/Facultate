...
# repeat (repeta fiecare elem de n ori) vs tile (coportament de tip copy-paste)
a = np.array([1,2,3])
...
# lstp = [i ** 2 for i in list]
end_lst = time.time()
durata_lst = end_lst - start_lst

print(f"Rezultate performanta: \nNumpy: {durata:.5f}\nPython: {durata_lst:.5f}\nRaport:{durata_lst/durata}")

# broadcasting
# broadcast simplu: inmultirea unui ndarray cu un scalar
# broadcast complex: inmultirea elem cu elem a termenilor din ndarray
...
print("Broadcast elem cu elem:\n", b * c)
print("Inmultire matematica a matricelor: \n", b @ c)
