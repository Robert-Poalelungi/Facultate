...
# repeat (repeta fiecare elem din array de n ori) vs
# tile (repeta intreaga structura ca intr-un copy-paste)
a = np.array([1,2,3])
...
print(f"Rezultate de performanta:\nNumpy: {duration:.5f}\nPython: {duration_list:.5f}\nRaport: {duration_list/duration:.5f}")

# broadcasting
# broadcast simplu: echivalentul inmultirii unui array cu un scalar
# broadcast complex: inmultirea elem cu elem a valorilor din arrays
