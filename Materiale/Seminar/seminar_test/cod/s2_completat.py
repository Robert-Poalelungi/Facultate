...
# tile (repeta intreaga structura de n ori - un fel de copy/paste) vs repeat (repeta fiecar elem din array de n ori)
a = np.array([1,2,3])
...
print(f"Rezultate perf \nNumpy: {duration:.5f}\nPython: {duration_lst:.5f}\nRaport: {duration_lst/duration:.5f}")

# broadcasting
# broadcast simplu: inmultirea unui ndarray cu un scalar
# broadcast complex: inmultirea termenilor din ndarrays elem cu elem
...
print("Broadcast elem cu elem (element-wise):\n", b * c)
print("Inmultirea matematica a 2 matrice:\n", b @ c)
